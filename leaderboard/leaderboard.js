    ...
    axios.post('https://acses-gim-maze-leaderboard.vercel.app/api/leaderboard/top')
        .then(response => {
            ...
            data.forEach((entry, index) => {
                ...
                box.classList.add('w-[500px]', 'mt-5', 'ml-auto', 'mr-auto', 'py-5', 'px-3', 'rounded-sm', 'bg-blue-200', 'bg-opacity-80');
                
                box.innerHTML = `
                <div
        class="box flex justify-between items-center text-white text-2xl font-bold font-[cursive] border-2 border-black px-3 py-5"
      >
